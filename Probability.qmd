...
or narrower (lower SD) distributions.](images/clipboard-2033562421.png){alt="Different SDs lead to wider (lower SD) or narrower (higher SD) distributions." width="221"}
:::
:::::
...
-   Research Hypothesis: Caffeine boosts cognitive performance.

-   Statistical Hypothesis: The group with a high caffeine intake will score higher on the exam than the group with low intake (high \> low intake).
