...
Open the file [`WorkshopData.csv`](https://github.com/Hillea/BasicStats-Retune/blob/main/Data/WorkshopData.csv) by clicking the three stripes on the upper left, "open", "browse" and searching for and selecting the file in the file explorer.
