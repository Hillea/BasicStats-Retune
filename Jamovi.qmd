...
Open the file `WorkshopData_Wide.csv` by clicking the three stripes on the upper left, "open", "browse" and searching for and selecting the file in the file explorer.
